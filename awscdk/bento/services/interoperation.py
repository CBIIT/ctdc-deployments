...
class interoperationService:
  def createService(self, config):
    ...
    environment={
            ...
            "DATE":"2024-07-09",
            "BENTO_BACKEND_GRAPHQL_URI":"/v1/graphql/",
            #"MYSQL_PORT":"3306",
    ...
    new_relic_container = taskDefinition.add_container(
        ...
        cpu=0,
        essential=True,
        secrets={"NRIA_LICENSE_KEY":ecs.Secret.from_secrets_manager(secretsmanager.Secret.from_secret_name_v2(self, "interopnr_newrelic", secret_name='monitoring/newrelic'), 'api_key'),},
        environment={
