...
class frontendService:
  def createService(self, config):
    ...
    environment={
            ...
            "REACT_APP_BACKEND_VERSION":config['backend']['image'],
            ...
            "REACT_APP_FILE_SERVICE_VERSION":config['files']['image'],
            "REACT_APP_INTEROP_SERVICE_VERSION":config['interop']['image'],
            "REACT_APP_INTEROP_SERVICE_URL":"/api/interoperation/",
            "REACT_APP_AUTH_SERVICE_VERSION":config['authn']['image'],
    ...
    secrets={
            ...
            #"REACT_APP_DMN_URL":ecs.Secret.from_secrets_manager(secretsmanager.Secret.from_secret_name_v2(self, "dmn", secret_name='bento-cdk/ctdc/dev'), 'react_app_data_model_navigator'),
