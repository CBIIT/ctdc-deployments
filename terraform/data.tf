...
resource "aws_iam_policy" "opensearch_snapshot_policy" {
  ...
  policy = length(data.aws_iam_policy_document.opensearch_snapshot_policy_document) > 0 ? data.aws_iam_policy_document.opensearch_snapshot_policy_document[0].json : "{}"
